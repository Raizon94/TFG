# 09 — Tests de Rendimiento

> **Objetivo**: Medir latencia, throughput y tiempos de respuesta de todos los componentes del sistema.
>
...
| Componente | Criterio |
|---|---|
| Endpoints REST | p50 < 200ms, p95 < 500ms |
| ML inference | p50 < 100ms |
| Throughput | > 20 req/s con 10 concurrentes |
| Errores | 0% bajo carga normal |

```bash
cd /Users/bilian/Desktop/TFG
python tests/run_09_rendimiento.py
```
